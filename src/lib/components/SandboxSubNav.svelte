...
{#if isVisible}
	<div class="absolute top-8 left-48 z-20 flex flex-col space-y-2 transition-all duration-300 ease-out">
		{#each subNavItems as item}
			<div
				class="font-sharpie cursor-pointer transition-all duration-300 ease-out hover:opacity-80 hover:scale-105 px-4 py-2 text-xl text-warm-white border-l-2 border-medium border-opacity-30 hover:border-opacity-100"
